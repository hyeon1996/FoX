...
def run(_run, _config, _log):
    ...
    if args.env == 'sc2':
        unique_token = "{}/{}_{}__{}_round_{}_beta1_{}_beta2_{}".format(args.env_args['map_name'],args.env_args['map_name'], args.name,
                                          datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"), args.round, args.beta1, args.beta2)
    elif str(args.env).startswith('academy'):  # for gfootball
        unique_token = "{}/{}/seed_{}_round_{}_lambda_{}".format(
            args.env_args['env_name'], args.name[:-6], args.seed, args.round, args.ld)
    else:
        unique_token = "{}/{}/seed_{}_round_{}_lambda_{}".format(
            args.env_args['env_name'], args.name[:-6], args.seed, args.round, args.ld)
    ...
    if args.use_tensorboard:
        ...
        tensorboard_dir = f'{tb_logs_direc}/{args.name[:-6]}/{env_name}/{unique_token}'
...
def run_sequential(args, logger):
    ...
    scheme = {
        ...
        "formation": {"vshape": (args.n_agents * 4,)},
